...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (url) {
                yield slack_1.default(url, jobStatus, version, platform, channel, downloadUrl);
...
function send(url, jobStatus, version, platform, channel, downloadUrl) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const ts = moment_1.default(new Date()).format('Do MMM YY [at] hh:mm');
        const blocks = [
            {
                type: 'section',
                text: {
